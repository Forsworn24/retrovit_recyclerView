package mudinov.ali.news_line.adapter
...
import mudinov.ali.news_line.R
...
//        val txt_createdby: TextView = itemView.txt_createdby
        ...
        fun bind(listItem: Movie) {
            image.setOnClickListener {
                Toast.makeText(it.context, "нажал на ${R.id.image_movie}", Toast.LENGTH_SHORT)
                    .show()
            }
            itemView.setOnClickListener {
                Toast.makeText(it.context, "нажал на ${R.id.txt_name}", Toast.LENGTH_SHORT).show()
            }
        }
    }
